/// Core utilities, extensions, and helpers (non-widget APIs).
///
/// For widgets, prefer focused entry points such as
/// `package:vvk_ui_kit/buttons.dart` or the full
/// `package:vvk_ui_kit/vvk_ui_kit.dart` barrel.
library;
